default[:quickstart][:web][:dir]     = "/var/www/quickstart"
default[:quickstart][:db][:database] = "quickstart"
default[:quickstart][:db][:deltas] = "/var/www/quickstart/src/sql"
default[:quickstart][:db][:user]     = "quickstart"
default[:quickstart][:db][:password] = "quickstart"
...
default[:php5][:error_handling][:error_reporting]           = "E_ALL & ~E_NOTICE"
